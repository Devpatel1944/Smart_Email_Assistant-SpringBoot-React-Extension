...
public class EmailGeneratorService {
    ...
    public String generateEmailReplay(EmailRequest emailRequest){
        ...
        Map<String, Object> buildRequestBody = Map.of(
                "contents", new Object[] {
                        Map.of(
                                "parts", new Object[] {
                                        Map.of("text", prompt)
    ...
    public String buildPrompt(EmailRequest emailRequest){
        ...
        prompt.append("Generate a professional email reply for the following email content. Please don't generate subject line. And provide only Best one Answer ");
